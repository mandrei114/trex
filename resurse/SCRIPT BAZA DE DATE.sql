...
alter table EXPENSE ADD COLUMN DESCRIPTION VARCHAR(255);

-- Add FK in Category to User - if user is deleted, delete categories he created
ALTER TABLE CATEGORY
  ADD COLUMN FK_USER INT(11) NOT NULL,
  ADD FOREIGN KEY FK_USER(FK_USER) REFERENCES USER(ID_USER) ON DELETE CASCADE;
